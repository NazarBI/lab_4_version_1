...
public class MultiExample {
    ...
    public static void main(String[] args) {
        String phrase = "Я не буду багато тобі речей розповідати";
        ...
        System.out.println("\nДрук фрази за допомогою циклу while:");
        int j = 0;
        while (j < 50) {
        ...
        System.out.println("\nДрук годин і хвилин за допомогою циклу while:");
        int hWhile = 0;
        while (hWhile <= 2) {
            int mWhile = 0;
            while (mWhile < 60) {
        ...
        System.out.println("\nЗначення функції з використанням циклу while:");
        double x = lowerLimit;
        while (x <= upperLimit) {
